...
export class CheckoutComponent {
  ...
  constructor(private api: ShopApiService, private layout: layoutService, private auth: AuthService, private cartService: CartService, private router: Router, private formBuilder: FormBuilder) {
